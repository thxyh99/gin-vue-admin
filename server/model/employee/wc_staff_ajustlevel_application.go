// 自动生成模板WcStaffAjustlevelApplication
package employee
...
// 调级申请 结构体  WcStaffAjustlevelApplication
type WcStaffAjustlevelApplication struct {
 global.GVA_MODEL 
      Title  string `json:"title" form:"title" gorm:"column:title;comment:调动标题;size:100;"`  //调动标题 
      StaffId  *int `json:"staffId" form:"staffId" gorm:"column:staff_id;comment:员工ID;size:10;"`  //员工ID 
      ...
      OaStatus  *bool `json:"oaStatus" form:"oaStatus" gorm:"column:oa_status;comment:OA状态;"`  //OA状态 
...
// TableName 调级申请 WcStaffAjustlevelApplication自定义表名 wc_staff_ajustlevel_application
func (WcStaffAjustlevelApplication) TableName() string {
  return "wc_staff_ajustlevel_application"
}
