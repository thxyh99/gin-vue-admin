...
type WcStaffSocial struct {
	...
	InjuryInsuranceBase *float64 `json:"injuryInsuranceBase" form:"injuryInsuranceBase" gorm:"column:injury_insurance_base;comment:工伤保险缴费基数;size:10;" binding:"required"` //工伤保险缴费基数
	InjuryInsuranceUnit *float64 `json:"injuryInsuranceUnit" form:"injuryInsuranceUnit" gorm:"column:injury_insurance_unit;comment:工伤保险单位缴费;size:10;" binding:"required"` //工伤保险单位缴费
