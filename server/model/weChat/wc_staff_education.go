...
type WcStaffEducation struct {
	...
	ProfessionalCertificate string     `json:"professionalCertificate" form:"professionalCertificate" gorm:"column:professional_certificate;comment:职称证书;size:200;"`                          //职称证书
	SkillCertificate        string     `json:"skillCertificate" form:"skillCertificate" gorm:"column:skill_certificate;comment:技能证书;size:200;"`                                               //技能证书
