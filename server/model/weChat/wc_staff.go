...
type WcStaff struct {
	...
	HouseholdType    *int       `json:"householdType" form:"householdType" gorm:"column:household_type;comment:户籍类型(1:本地城镇 2:本地农村 3:外地城镇 4:外地农村);size:1;" binding:"required"`  //户籍类型(1:本地城镇 2:本地农村 3:外地城镇 4:外地农村)
