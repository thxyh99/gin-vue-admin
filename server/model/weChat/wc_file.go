...
type WcFile struct {
	...
	Type    *int   `json:"type" form:"type" gorm:"column:type;comment:文件分类(0:其它 1:合同附件 2:身份证(人像) 3:身份证(国徽) 4:学历证书 5:学位证书 6:前公司离职证明 7:员工入职申请表 8:试用期管理规定 9:个人简历 10:职称/技能证书 11:健康证);size:2;" binding:"required"` //文件分类(0:其它 1:合同附件 2:身份证(人像) 3:身份证(国徽) 4:学历证书 5:学位证书 6:前公司离职证明 7:员工入职申请表 8:试用期管理规定 9:个人简历 10:职称/技能证书 11:健康证)
