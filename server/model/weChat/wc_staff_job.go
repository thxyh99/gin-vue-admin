...
type WcStaffJob struct {
	...
	EmploymentHeadquarterDate *time.Time `json:"employmentHeadquarterDate" form:"employmentHeadquarterDate" gorm:"column:employment_headquarter_date;comment:入职总部日期;" binding:"required"` //入职总部日期
