...
// CreateWcStaff 创建员工管理
// @Tags WcStaff
// @Summary 创建员工管理
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body weChat.WcStaff true "创建员工管理"
...
// DeleteWcStaff 删除员工管理
// @Tags WcStaff
// @Summary 删除员工管理
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body weChat.WcStaff true "删除员工管理"
...
// UpdateWcStaff 更新员工管理
// @Tags WcStaff
// @Summary 更新员工管理
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body weChat.WcStaff true "更新员工管理"
...
// FindWcStaff 用id查询员工管理
// @Tags WcStaff
// @Summary 用id查询员工管理
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data query weChat.WcStaff true "用id查询员工管理"
...
// GetWcStaffList 分页获取员工管理列表
// @Tags WcStaff
// @Summary 分页获取员工管理列表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data query weChatReq.WcStaffSearch true "分页获取员工管理列表"
...
// GetWcStaffPublic 不需要鉴权的员工管理接口
// @Tags WcStaff
// @Summary 不需要鉴权的员工管理接口
// @accept application/json
// @Produce application/json
// @Param data query weChatReq.WcStaffSearch true "分页获取员工管理列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
