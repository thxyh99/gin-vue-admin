...
// @Param data body model.WcStaff true "创建员工管理"
...
// @accept application/json
// @Produce application/json
// @Param data body model.WcStaff true "删除员工管理"
...
// @accept application/json
// @Produce application/json
// @Param data body request.IdsReq true "批量删除员工管理"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"删除成功"}"
// @Router /wcStaff/deleteWcStaff [delete]
...
// @accept application/json
// @Produce application/json
// @Param data body model.WcStaff true "更新员工管理"
...
// @accept application/json
// @Produce application/json
// @Param data query model.WcStaff true "用id查询员工管理"
...
// @accept application/json
// @Produce application/json
// @Param data query request.PageInfo true "分页获取员工管理列表"
