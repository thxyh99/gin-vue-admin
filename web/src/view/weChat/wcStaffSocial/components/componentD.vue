<template>
	<div>
		<div class="gva-search-box">
			...
			>
				<el-form-item label="关键词">
					<el-input style="width: 190px" v-model="searchInfo.keyword" placeholder="请输入个人账号、证件号码" />
				</el-form-item>
        ...
        <ExportExcel template-id="staffSocialDgGjj" type="4" :limit="9999" btnName="导出东莞公积金" :staff-id="searchInfo.staffId" :period="searchInfo.period" :keyword="searchInfo.keyword"/>
        ...
        >
			...
			>
				...
				<el-table-column align="left" label="成员名称" prop="staffName" width="90" />
				<el-table-column align="left" label="员工工号" prop="jobNum" width="120" />
				<el-table-column align="left" label="个人账号" prop="account" width="150" />
				<el-table-column align="left" label="证件类型" prop="credentialTypeText" width="120" />
				<el-table-column align="left" label="证件号码" prop="credentialNumber" width="180" />
        <el-table-column align="left" label="缴存基数" prop="housingBase" width="90" />
        <el-table-column align="left" label="单位缴存比例" prop="housingRatioUnit" width="110" />
        <el-table-column align="left" label="个人缴存比例" prop="housingRatioSelf" width="110" />
        <el-table-column align="left" label="单位缴存额" prop="totalHousingUnit" width="110" />
        <el-table-column align="left" label="个人缴存额" prop="totalHousingSelf" width="110" />
        <el-table-column align="left" label="月缴额" prop="totalHousing" width="90" />
        <el-table-column align="left" label="缴存年月" prop="periodStart" width="90" />
...
<!--						>-->
        ...
        <el-descriptions-item label="单位缴存额">
          {{ formData.totalHousingUnit }}
        </el-descriptions-item>
        <el-descriptions-item label="个人缴存额">
          {{ formData.totalHousingSelf }}
        </el-descriptions-item>
				<el-descriptions-item label="月缴额">
					{{ formData.totalHousing }}
				</el-descriptions-item>
				<el-descriptions-item label="缴存年月">
...
const tableData = ref([])
const searchInfo = ref({type:4})

// 重置
const onReset = () => {
	searchInfo.value = {type:4}
	getTableData()
}
