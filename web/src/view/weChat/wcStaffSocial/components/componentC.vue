<template>
	<div>
        ...
        <ExportExcel template-id="staffSocialDgSb" type="3" :limit="9999" btnName="导出东莞社保" :staff-id="searchInfo.staffId" :period="searchInfo.period" :keyword="searchInfo.keyword"/>
...
<!--						>-->
        ...
        <el-descriptions-item label="费款所属期止">
          {{ formData.periodEnd }}
				...
				<el-descriptions-item label="应缴金额合计">
					{{ formData.totalSocial }}
				</el-descriptions-item>
				<el-descriptions-item label="个人部分合计">
					{{ formData.totalSocialSelf }}
				</el-descriptions-item>
				<el-descriptions-item label="单位部分合计">
					{{ formData.totalSocialUnit }}
				</el-descriptions-item>
				<el-descriptions-item label="企业基本养老保险缴费基数">
					{{ formData.pensionBase }}
				</el-descriptions-item>
        <el-descriptions-item label="企业基本养老保险应缴金额(单位缴纳)">
          {{ formData.pensionUnit }}
        </el-descriptions-item>
				<el-descriptions-item label="企业基本养老保险应缴金额(个人缴纳)">
					{{ formData.pensionSelf }}
				</el-descriptions-item>
        <el-descriptions-item label="失业保险缴纳基数">
          {{ formData.unemployedBase }}
        </el-descriptions-item>
        <el-descriptions-item label="失业保险应缴金额(单位缴纳)">
          {{ formData.unemployedUnit }}
        </el-descriptions-item>
        <el-descriptions-item label="失业保险应缴金额(个人缴纳)">
          {{ formData.unemployedSelf }}
        </el-descriptions-item>
				<el-descriptions-item label="单建统筹职工医保（含生育）缴纳基数">
					{{ formData.medicalBase }}
				</el-descriptions-item>
        <el-descriptions-item label="单建统筹职工医保（含生育）应缴金额（单位缴纳）">
          {{ formData.medicalUnit }}
        </el-descriptions-item>
				<el-descriptions-item label="单建统筹职工医保（含生育）应缴金额（个人缴纳）">
					{{ formData.medicalSelf }}
				</el-descriptions-item>
				<el-descriptions-item label="工伤保险缴纳基数">
					{{ formData.injuryInsuranceBase }}
				</el-descriptions-item>
				<el-descriptions-item label="工伤保险应缴金额">
