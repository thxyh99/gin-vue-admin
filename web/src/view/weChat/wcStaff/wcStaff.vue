...
<!--        </div>-->
        ...
        <el-table-column align="left" label="成员UserID" prop="userid" width="120" />
        <el-table-column align="left" label="成员名称" prop="name" width="120" />
        <el-table-column align="left" label="成员所属部门ID" prop="department" width="120" />
        ...
        <el-table-column align="left" label="表示在所在的部门内是否为部门负责人" prop="isLeaderInDept" width="120" />
        <el-table-column align="left" label="直属上级UserID" prop="directLeader" width="120" />
        <el-table-column align="left" label="头像" prop="avatar" width="120" />
        <el-table-column align="left" label="头像缩略图" prop="thumbAvatar" width="120" />
        ...
        <el-table-column align="left" label="全局唯一" prop="openUserid" width="120" />
        <el-table-column align="left" label="主部门" prop="mainDepartment" width="120" />
        ...
        <el-table-column align="left" label="员工个人二维码" prop="qrCode" width="120" />
        <el-table-column align="left" label="对外职务" prop="externalPosition" width="120" />
                      <el-table-column label="成员对外属性" width="200">
                         <template #default="scope">
                            [富文本内容]
                         </template>
                      </el-table-column>
...
<!--            <el-button type="primary" link icon="edit" class="table-button" @click="updateWcStaffFunc(scope.row)">变更</el-button>-->
<!--            <el-button type="primary" link icon="delete" @click="deleteRow(scope.row)">删除</el-button>-->
       ...
       <template #title>
          ...
          <el-form :model="formData" label-position="top" ref="elFormRef" :rules="rule" label-width="80px">
            ...
            <el-form-item label="主部门:"  prop="mainDepartment" >
              <el-input v-model.number="formData.mainDepartment" :clearable="true" placeholder="请输入主部门" />
            </el-form-item>
    ...
    <el-drawer size="800" v-model="detailShow" :before-close="closeDetailShow" title="查看详情" destroy-on-close>
        ...
        <el-descriptions :column="1" border>
                <el-descriptions-item label="成员UserID">
                        {{ formData.userid }}
                ...
                <el-descriptions-item label="表示在所在的部门内是否为部门负责人">
                        {{ formData.isLeaderInDept }}
                </el-descriptions-item>
                <el-descriptions-item label="直属上级UserID">
                        {{ formData.directLeader }}
                </el-descriptions-item>
                <el-descriptions-item label="头像">
                        {{ formData.avatar }}
                </el-descriptions-item>
                <el-descriptions-item label="头像缩略图">
                        {{ formData.thumbAvatar }}
                </el-descriptions-item>
                ...
                <el-descriptions-item label="全局唯一">
                        {{ formData.openUserid }}
                </el-descriptions-item>
                ...
                <el-descriptions-item label="员工个人二维码">
                        {{ formData.qrCode }}
                </el-descriptions-item>
                <el-descriptions-item label="对外职务">
                        {{ formData.externalPosition }}
                </el-descriptions-item>
                <el-descriptions-item label="成员对外属性">
                        [富文本内容]
                </el-descriptions-item>
        </el-descriptions>
    </el-drawer>
