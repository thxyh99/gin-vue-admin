  ...
  <div>
    ...
    <div class="gva-table-box">
      <div class="gva-btn-list">
        <ExportExcel template-id="staffSalary234" type="4" :limit="9999" btnName="导出半年奖" :staff-id="searchInfo.staffId" :month="searchInfo.month" :keyword="searchInfo.keyword"/>
      ...
      >
        ...
        <el-table-column align="left" label="应发" prop="shouldPay" width="120" />
        <el-table-column align="left" label="个税" prop="thisShouldPayTax" width="120" />
        <el-table-column align="left" label="实发" prop="actualPay" width="120" />
