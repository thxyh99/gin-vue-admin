  ...
  <div>
    ...
    <div class="gva-table-box">
      <div class="gva-btn-list">
        <ExportExcel template-id="staffSalary8" type="8" :limit="9999" btnName="导出总部调理中心体系月度奖金" :staff-id="searchInfo.staffId" :month="searchInfo.month" :keyword="searchInfo.keyword"/>
