  ...
  <div>
    ...
    <div class="gva-table-box">
      <div class="gva-btn-list">
        <ExportExcel template-id="staffSalary6" type="6" :limit="9999" btnName="导出总部职能体系月度奖金" :staff-id="searchInfo.staffId" :month="searchInfo.month" :keyword="searchInfo.keyword"/>
      ...
      >
        ...
        <el-table-column align="left" label="对应职等" prop="position" width="120" />
        ...
        <el-table-column align="left" label="应发奖金" prop="shouldPay" width="120" />
        <el-table-column align="left" label="个税" prop="thisShouldPayTax" width="120" />
        <el-table-column align="left" label="实发奖金" prop="actualPay" width="120" />
...
<!--            <el-button type="primary" link icon="edit" class="table-button" @click="updateWcStaffSalaryFunc(scope.row)">变更</el-button>-->
    ...
    <el-drawer size="800" v-model="detailShow" :before-close="closeDetailShow" title="查看详情" destroy-on-close>
      ...
      <el-descriptions :column="1" border>
        ...
        <el-descriptions-item label="应发奖金">
          {{ formData.shouldPay }}
        </el-descriptions-item>
        <el-descriptions-item label="个税">
          {{ formData.thisShouldPayTax }}
        </el-descriptions-item>
        <el-descriptions-item label="实发奖金">
          {{ formData.actualPay }}
        </el-descriptions-item>
...
const tableData = ref([])
const searchInfo = ref({type:6})

// 重置
const onReset = () => {
  searchInfo.value = {type:6}
  getTableData()
}
