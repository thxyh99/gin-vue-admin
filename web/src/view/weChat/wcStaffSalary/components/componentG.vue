  ...
  <div>
    ...
    <div class="gva-table-box">
      <div class="gva-btn-list">
        <ExportExcel template-id="staffSalary7" type="7" :limit="9999" btnName="导出总部金纳斯市场体系月度奖金" :staff-id="searchInfo.staffId" :month="searchInfo.month" :keyword="searchInfo.keyword"/>
      ...
      >
        ...
        <el-table-column align="left" label="全年任务（万）" prop="annualTask" width="130" />
        ...
        <el-table-column align="left" label="市场差补服务费" prop="marketServiceFee" width="130" />
        <el-table-column align="left" label="月度奖励" prop="monthlyReward" width="120" />
        <el-table-column align="left" label="品牌负责人月度补贴" prop="monthlyLeaderSubsidy" width="150" />
...
const tableData = ref([])
const searchInfo = ref({type:7})

// 重置
const onReset = () => {
  searchInfo.value = {type:7}
  getTableData()
}
