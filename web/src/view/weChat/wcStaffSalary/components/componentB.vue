  ...
  <div>
    ...
    <div class="gva-table-box">
      <div class="gva-btn-list">
        <ExportExcel template-id="staffSalary234" type="2" :limit="9999" btnName="导出集团经营绩效奖励" :staff-id="searchInfo.staffId" :month="searchInfo.month" :keyword="searchInfo.keyword"/>
